...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            lsp_adapter::rust_lsp_open,
            lsp_adapter::rust_lsp_change,
            lsp_adapter::rust_lsp_close,
            lsp_adapter::rust_lsp_completion,
            lsp_adapter::rust_lsp_hover,
            lsp_adapter::rust_lsp_definition,
